...
'''
F_sol = F_sol_1UA (L) #Flux solaire à 1UA
F_p_Earth = F_p_sol_1UA (L,R_Terre,T_Terre) #Flux thermique de la Terre
F_r_Earth = A_B * (R_Terre**2)/(4*AU**2) * F_sol #Flux réfléchi de la Terre
C_Earth_Sol = (F_p_Earth+F_r_Earth)/F_sol

print 'C_Earth_Sol',C_Earth_Sol
'''
...
################################################################################
Cibles(L,R,C,F_p,F_rp,Time,T_max,B_max)
